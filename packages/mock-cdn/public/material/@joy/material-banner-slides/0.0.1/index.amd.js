define("@joy/material-banner-slides", ["vue"], function(vue) {
  "use strict";
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          vue.createElementVNode("div", _hoisted_1, [
            (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, vue.renderList(list, (item, i) => {
              return vue.createElementVNode("div", {
                class: vue.normalizeClass(["banner-slides-item", { fade: index.value === i }]),
                key: item.id,
          ...
          vue.createElementVNode("div", _hoisted_3, [
            (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, vue.renderList(list, (item, i) => {
              return vue.createElementVNode("span", {
                class: vue.normalizeClass(["banner-slides-pointer", { active: index.value === i }]),
                key: i,
